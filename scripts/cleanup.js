// scripts/cleanup.js
// Retention. Runs after every scheduled fetch and drops day files past the window,
// then resyncs data/index.json against what's actually on disk. latest.json is
// never touched.
